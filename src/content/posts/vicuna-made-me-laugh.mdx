...
Two weeks ago, I found [Vicuna](https://lmsys.org/blog/2023-03-30-vicuna/), "an open-source chatbot impressing GPT-4 with 90%* ChatGPT quality". I knew to take that 90% stat with a pinch of salt but wanted to try it.
