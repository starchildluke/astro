...
And the headings font is different. [Erode](https://www.fontshare.com/fonts/erode) was nice but I wanted something as close to [Tiempos Text](https://klim.co.nz/fonts/tiempos-text/) as I could get that was 1) free and 2) small in file size as not to impact performance. In the end, I opted for a Google font of all things and [DM Serif Display](https://fonts.google.com/specimen/DM+Serif+Display) was the answer (via some subsetting).
