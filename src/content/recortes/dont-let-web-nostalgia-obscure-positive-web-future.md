...
what we should be doing is taking *inspiration* from what made those times happier and forge a better future with what we have now. living in the present, carving out our own little spaces on the Web, making them **accessible to everyone**, not using tables for layouts (seriously, try [grid](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_grid_layout) and [flexbox](https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Flexible_box_layout/Basic_concepts)).
